...
export default async function SettingsProfilePage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <form action={saveClinicProfileAction} className="grid gap-3 rounded-lg border p-4 md:grid-cols-2" encType="multipart/form-data">
        ...
        <input name="logo_file" type="file" accept="image/*" className="rounded-md border px-3 py-2 md:col-span-2" />
        ...
        <input name="signature_file" type="file" accept="image/*" className="rounded-md border px-3 py-2 md:col-span-2" />
